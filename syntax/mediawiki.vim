...
syn match mediawikiKeyword contained "\<\(cite web\|accessdate\|archivedate\|archiveurl\|doi\|dts\|journal\|volume\|issue\|quote\|cquote\|website\|arxiv\|jstor\|rp\|publisher\|first1\|last1\|first\|last\|first1\|last2\|snd\)\>" contains=@NoSpell
